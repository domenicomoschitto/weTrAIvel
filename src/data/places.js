...
export const PLACES = [
  ...
  { name: 'bologna',    display_name: 'Bologna',    type: 'city',              region: 'emilia-romagna', country_code: 'IT', ...u('1730145612903-d5fe98515c47') },
  { name: 'turin',      display_name: 'Turin',      aliases: ['torino'],       region: 'piemonte',       type: 'city', country_code: 'IT', ...u('1651453796204-5a9e98744dd3') },
  { name: 'genoa',      display_name: 'Genoa',      aliases: ['genova'],       region: 'liguria',        type: 'city', country_code: 'IT', ...u('1666397141790-fe20b6bfd48c') },
  { name: 'palermo',    display_name: 'Palermo',    type: 'city',              region: 'sicily',         country_code: 'IT', ...u('1555881400-74d7acaacd7e') },
  { name: 'catania',    display_name: 'Catania',    type: 'city',              region: 'sicily',         country_code: 'IT', ...u('1624121508525-0234b63a58c7') },
  { name: 'messina',    display_name: 'Messina',    type: 'city',              region: 'sicily',         country_code: 'IT', ...s('messina sicily strait') },
  { name: 'siracusa',   display_name: 'Siracusa',   aliases: ['syracuse','siracusa'],     region: 'sicily',         type: 'city', country_code: 'IT', ...u('1593290904368-e993b56accc9') },
  { name: 'ragusa',     display_name: 'Ragusa',     type: 'city',              region: 'sicily',         country_code: 'IT', ...s('ragusa ibla sicily baroque') },
  { name: 'trapani',    display_name: 'Trapani',    type: 'city',              region: 'sicily',         country_code: 'IT', ...u('1601387434127-20979856e76e') },
  { name: 'agrigento',  display_name: 'Agrigento',  type: 'city',              region: 'sicily',         country_code: 'IT', ...u('1708960147250-89970160c625') },
  ...
  { name: 'bari',       display_name: 'Bari',       type: 'city',              region: 'puglia',         country_code: 'IT', ...u('1686431998943-e650743a3b3d') },
  { name: 'lecce',      display_name: 'Lecce',      type: 'city',              region: 'puglia',         country_code: 'IT', ...u('1594654832299-4160d15397f4') },
  { name: 'alberobello',display_name: 'Alberobello', type: 'city',             region: 'puglia',         country_code: 'IT', ...s('alberobello trulli puglia') },
  { name: 'brindisi',   display_name: 'Brindisi',   type: 'city',              region: 'puglia',         country_code: 'IT', ...u('1707228907075-37950f16df14') },
  ...
  { name: 'verona',     display_name: 'Verona',     type: 'city',              region: 'veneto',         country_code: 'IT', ...u('1544519838-0f1346c8bcf0') },
  { name: 'padova',     display_name: 'Padua',      aliases: ['padua','padova'], region: 'veneto',       type: 'city', country_code: 'IT', ...u('1652987363975-958fd0ffacaa') },
  ...
  { name: 'siena',      display_name: 'Siena',      type: 'city',              region: 'tuscany',        country_code: 'IT', ...u('1660814534481-16a8747a6851') },
  { name: 'pisa',       display_name: 'Pisa',       type: 'city',              region: 'tuscany',        country_code: 'IT', ...u('1725909455040-51a3948ed121') },
  ...
  { name: 'salerno',    display_name: 'Salerno',    type: 'city',              region: 'campania',       country_code: 'IT', ...u('1636633079017-dc209d857d0b') },
  { name: 'caserta',    display_name: 'Caserta',    type: 'city',              region: 'campania',       country_code: 'IT', ...u('1717500628459-b12e4127a50c') },
  ...
  { name: 'modena',     display_name: 'Modena',     type: 'city',              region: 'emilia-romagna', country_code: 'IT', ...u('1666380883724-0448ce208f40') },
  ...
  { name: 'rimini',     display_name: 'Rimini',     aliases: ['rimini & riccione','rimini riccione'], region: 'emilia-romagna', type: 'city', country_code: 'IT', ...u('1574023618282-98fa4f48cb33') },
  { name: 'aosta',      display_name: 'Aosta',      type: 'city',              region: 'valle-d-aosta',  country_code: 'IT', ...s('aosta valley alps castle') },
  { name: 'livorno',    display_name: 'Livorno',    aliases: ['leghorn'],      region: 'tuscany',        type: 'city', country_code: 'IT', ...u('1601469197437-fe3631edccd9') },
  { name: 'tropea',     display_name: 'Tropea',     type: 'city',              region: 'calabria',       country_code: 'IT', ...u('1592667921949-38d0bfe14b05') },
  { name: 'reggio-emilia', display_name: 'Reggio Emilia', aliases: ['reggio emilia'], region: 'emilia-romagna', type: 'city', country_code: 'IT', ...u('1593445553267-c9dcd410b76c') },
